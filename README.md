# Rainmaker Obsidian - Letta AI Agent Plugin

> **Fork Notice:** This is a fixed fork of [letta-ai/letta-obsidian](https://github.com/letta-ai/letta-obsidian). Part of PROJECT RAINMAKER.

## Changes from Upstream

- **Fixed connection race condition** - Proper mutex pattern prevents duplicate connections
- **Fixed memory leaks** - Event listeners properly cleaned up on view close
- **Re-enabled tool registration** - Vault manipulation tools (read/write/search) now work
- **Added message load protection** - Prevents state corruption from concurrent loads
...
1. Download the latest release from the [releases page](https://github.com/YOUR_USERNAME/rainmaker-obsidian/releases)
2. Extract the files to your vault's `.obsidian/plugins/rainmaker-obsidian/` directory
...
1. Clone this repository into your vault's `.obsidian/plugins/` directory:
   ```bash
   git clone https://github.com/YOUR_USERNAME/rainmaker-obsidian.git rainmaker-obsidian
   ```
